...
class Config(BaseModel):
    flood_avoid_delay: float = Field(default=5.0, description="Delay between new messages to avoid flooding (sec)")
    ...
    character_file: str = Field(default="Kaki-2.json", description="")
